...
urlpatterns = [
    ...
    path('admin/analytics/', superadmin_views.SuperAdminAnalyticsView.as_view(), name='admin-analytics'),
    path('admin/activity/', superadmin_views.SuperAdminActivityView.as_view(), name='admin-activity'),
    ...
    path('admin/bulk-action/', superadmin_views.SuperAdminBulkActionView.as_view(), name='admin-bulk-action'),
    path('admin/export-users/', superadmin_views.SuperAdminExportUsersView.as_view(), name='admin-export-users'),
    path('admin/settings/', superadmin_views.SuperAdminSettingsView.as_view(), name='admin-settings'),
    ...
    path('user/resume/autofill/', admin_views.DashboardResumeAutofillView.as_view(), name='user-resume-autofill'),
    ...
    path('dashboard/resume/autofill/', admin_views.DashboardResumeAutofillView.as_view(), name='dashboard-resume-autofill'),
